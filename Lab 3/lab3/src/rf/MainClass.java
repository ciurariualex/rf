	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int count = 1; count < learningSet.length; count++) {
				...
				double cityBlock = DistanceUtils.calculateCityBlock(learningSet[0], learningSet[count]);
				System.out.println("City Block distance between form 0 and form " + count + " is " + cityBlock);
				
				double mahalanobisDistance = DistanceUtils.calculateMahalanobisDistance(learningSet[0], learningSet[count], learningSet[0].length);
